                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return `
                         ...
                         <a class="btn btn-info" data-bs-toggle="offcanvas" href="#offcanvasEnd" role="button" aria-controls="offcanvasEnd" onclick='editform(${JSON.stringify(row)})'>
                          Edit
                        </a>
                        <a class="btn btn-danger" href="#" onclick="deleteRecord('/admin/roles/${row.id}', null)">Delete</a>
                        `;
                    }
                },
