                          ...
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/beautiful-blonde-woman-relaxing-with-a-can-of-coke-on-a-tree-stump-by-the-beach.jpg')}}" alt="Beautiful blonde woman relaxing with a can of coke on a tree stump by the beach" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/brainstorming-session-with-creative-designers.jpg')}}" alt="Brainstorming session with creative designers" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/finances-us-dollars-and-bitcoins-currency-money.jpg')}}" alt="Finances - US Dollars and Bitcoins - Currency - Money" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/group-of-people-brainstorming-and-taking-notes-2.jpg')}}" alt="Group of people brainstorming and taking notes" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/blue-sofa-with-pillows-in-a-designer-living-room-interior.jpg')}}" alt="Blue sofa with pillows in a designer living room interior" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg')}}" alt="Home office desk with Macbook, iPhone, calendar, watch & organizer" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="row g-2">
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/group-of-people-sightseeing-in-the-city.jpg')}}" alt="Group of people sightseeing in the city" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/color-palette-guide-sample-colors-catalog-.jpg')}}" alt="Color Palette Guide. Sample Colors Catalog." class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/stylish-workplace-with-computer-at-home.jpg')}}" alt="Stylish workplace with computer at home" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/pink-desk-in-the-home-office.jpg')}}" alt="Pink desk in the home office" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/young-woman-sitting-on-the-sofa-and-working-on-her-laptop.jpg')}}" alt="Young woman sitting on the sofa and working on her laptop" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                          <div class="col-6 col-sm-4">
                            <label class="form-imagecheck mb-2">
                              ...
                              <span class="form-imagecheck-figure">
                                <img src="{{asset('admin/static/photos/coffee-on-a-table-with-other-items.jpg')}}" alt="Coffee on a table with other items" class="form-imagecheck-image">
                              </span>
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                          <label class="form-selectgroup-item flex-fill">
                            ...
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                              ...
                              <div class="form-selectgroup-label-content d-flex align-items-center">
                                <span class="avatar me-3" style="background-image: url({{asset('admin/static/avatars/000m.jpg')}})"></span>
                                <div>
                          ...
                          <label class="form-selectgroup-item flex-fill">
                            ...
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                              ...
                              <div class="form-selectgroup-label-content d-flex align-items-center">
                                <span class="avatar me-3" style="background-image: url({{asset('admin/static/avatars/002m.jpg')}})"></span>
                                <div>
                          ...
                          <label class="form-selectgroup-item flex-fill">
                            ...
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                              ...
                              <div class="form-selectgroup-label-content d-flex align-items-center">
                                <span class="avatar me-3" style="background-image: url({{asset('admin/static/avatars/003m.jpg')}})"></span>
                                <div>
                          ...
                          <label class="form-selectgroup-item flex-fill">
                            ...
                            <div class="form-selectgroup-label d-flex align-items-center p-3">
                              ...
                              <div class="form-selectgroup-label-content d-flex align-items-center">
                                <span class="avatar me-3" style="background-image: url({{asset('admin/static/avatars/000f.jpg')}})"></span>
                                <div>
                    ...
                    <div class="col-md-6 col-xl-12">
                      ...
                      <div class="mb-3">
                        ...
                        <select type="text" class="form-select" id="select-people" value="">
                          <option value="1" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/000m.jpg')}})&quot;&gt;&lt;/span&gt;">Paweł Kuna</option>
                          <option value="2" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;JL&lt;/span&gt;">Jeffie Lewzey</option>
                          <option value="3" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/002m.jpg')}})&quot;&gt;&lt;/span&gt;">Mallory Hulme</option>
                          <option value="4" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/003m.jpg')}})&quot;&gt;&lt;/span&gt;">Dunn Slane</option>
                          <option value="5" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/000f.jpg')}})&quot;&gt;&lt;/span&gt;">Emmy Levet</option>
                          <option value="6" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/001f.jpg')}})&quot;&gt;&lt;/span&gt;">Maryjo Lebarree</option>
                          <option value="7" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;EP&lt;/span&gt;">Egan Poetz</option>
                          <option value="8" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/002f.jpg')}})&quot;&gt;&lt;/span&gt;">Kellie Skingley</option>
                          <option value="9" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/003f.jpg')}})&quot;&gt;&lt;/span&gt;">Christabel Charlwood</option>
                          <option value="10" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;HS&lt;/span&gt;">Haskel Shelper</option>
                          <option value="11" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/006m.jpg')}})&quot;&gt;&lt;/span&gt;">Lorry Mion</option>
                          <option value="12" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/004f.jpg')}})&quot;&gt;&lt;/span&gt;">Leesa Beaty</option>
                          <option value="13" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/007m.jpg')}})&quot;&gt;&lt;/span&gt;">Perren Keemar</option>
                          <option value="14" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;SA&lt;/span&gt;">Sunny Airey</option>
                          <option value="15" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/009m.jpg')}})&quot;&gt;&lt;/span&gt;">Geoffry Flaunders</option>
                          <option value="16" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/010m.jpg')}})&quot;&gt;&lt;/span&gt;">Thatcher Keel</option>
                          <option value="17" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/005f.jpg')}})&quot;&gt;&lt;/span&gt;">Dyann Escala</option>
                          <option value="18" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/006f.jpg')}})&quot;&gt;&lt;/span&gt;">Avivah Mugleston</option>
                          <option value="19" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot;&gt;AA&lt;/span&gt;">Arlie Armstead</option>
                          <option value="20" data-custom-properties="&lt;span class=&quot;avatar avatar-xs&quot; style=&quot;background-image: url({{asset('admin/static/avatars/008f.jpg')}})&quot;&gt;&lt;/span&gt;">Tessie Curzon</option>
                        </select>
                      </div>
                      <div class="mb-3">
              ...
              <form class="card">
                ...
                <div class="card-body">
                  <div class="mb-3">
                    <div class="row">
                      <div class="col-auto">
                        <span class="avatar avatar-md" style="background-image: url({{asset('admin/static/avatars/002m.jpg')}})"></span>
                      </div>
                      <div class="col">
                        <div class="mb-3">
